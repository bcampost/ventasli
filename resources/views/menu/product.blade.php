  ...
  <div class="pd-wrap">
    ...
    <div class="layout">
      ...
      <div class="card">
        ...
        <div class="media"> {{-- BOTÓN DESCARGAR --}}
          <a id="pdDownloadBtn" href="#" download class="download-img-btn" title="Descargar imagen">
            ⬇
          </a>
      ...
      <div class="card">
        ...
        <div class="info">
          ...
          <div class="product-description">
            {!! nl2br(e($detail->description ?: ($product->description ?: 'Sin descripción.'))) !!}
          </div>
        </div>
