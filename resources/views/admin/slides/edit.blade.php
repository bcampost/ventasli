...
@section('content')
  ...
  <div class="wrap">
    ...
    <div class="panel">
      ...
      <form class="body" method="POST" action="{{ route('admin.slides.update', $slide->id) }}"
          ...
          <div style="display:flex; flex-direction:column; gap:12px;">
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:12px;">
              <div>
                ...
                <input class="input" type="number" name="sort_order"
                  value="{{ old('sort_order', $slide->sort_order ?? 0) }}" min="0">
              </div>

              <div style="display:flex; align-items:flex-end; gap:10px; padding-bottom:6px;">
                <input id="is_active" name="is_active" type="checkbox" class="rounded" value="1" {{ old('is_active', (int) ($slide->is_active ?? 0)) ? 'checked' : '' }}>
            ...
            <div>
              ...
              <input class="input" type="datetime-local" name="expires_at"
                value="{{ old('expires_at', $slide->expires_at ? \Carbon\Carbon::parse($slide->expires_at)->format('Y-m-d\TH:i') : '') }}">
            </div>
