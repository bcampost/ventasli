      ...
      <div class="grid">
        <div class="space-y-4" style="display:flex; flex-direction:column; gap:12px;">
          <div>
            ...
            <input class="input" type="text" name="title" value="{{ old('title') }}" placeholder="Ej. Escritorios - Línea Italia">
          </div>
          ...
          <div>
            ...
            <input id="image" class="input" style="padding:.75rem 1rem;" type="file" name="image" accept="image/*" required>
            <div class="muted" style="margin-top:8px;">Tip: usa imágenes horizontales para que el slider se vea pro.</div>
          </div>
        </div>
