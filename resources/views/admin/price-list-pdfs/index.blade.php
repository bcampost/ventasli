    ...
    <div class="safe-area-right px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white rounded-2xl shadow p-5">
        <div class="flex items-start justify-between gap-4">
          <div>
            <h1 class="text-2xl font-semibold">Archivos · Lista de precios</h1>
            <p class="text-gray-600 mt-1">
              Sube/reemplaza el archivo de cada opción. Acepta <b>PDF</b>, <b>Word</b> (.doc/.docx), <b>Excel</b>
              (.xls/.xlsx) e <b>imágenes</b> (.jpg/.png/.gif/.webp/.svg). Se guardan en <code>public/pdfs</code>.
            </p>
          </div>
        ...
        @else
          ...
          <div class="mt-6 p-4 rounded-2xl border bg-gray-50">
            ...
            <form method="POST" action="{{ route('admin.price-list-pdfs.store') }}"
              class="flex items-center gap-2 flex-wrap">
              @csrf
              <input type="text" name="label" placeholder="Ej. Accesorios"
                class="w-full max-w-sm rounded-xl border-gray-300 text-sm" required>
          ...
          <div class="mt-6 space-y-4">
            @forelse($children as $child)
              @php
                ...
                $currentExt = $child->url ? strtolower(pathinfo($child->url, PATHINFO_EXTENSION)) : null;
                $currentLabel = match ($currentExt) {
                  'pdf' => 'PDF',
                  'doc', 'docx' => 'Word',
                  'xls', 'xlsx' => 'Excel',
                ...
                $slugForName = $child->slug ?: \Illuminate\Support\Str::slug($child->label, '-');
                $suggestedBase = 'lista-precios-' . $slugForName;
              @endphp
                ...
                <div class="flex items-start justify-between gap-4 flex-wrap">
                  <div class="min-w-0">
                    ...
                    <div class="text-sm text-gray-600 mt-1">
                      Nombre base: <code>{{ $suggestedBase }}.&lt;ext&gt;</code>
                    </div>
                    <div class="text-sm text-gray-600 mt-1">
                  ...
                  <div class="flex-none">
                    <form method="POST" action="{{ route('admin.price-list-pdfs.upload', $child) }}"
      ...
      <div class="mt-6 bg-white rounded-2xl shadow p-5">
        ...
        <ol class="list-decimal pl-6 mt-2 text-gray-700 space-y-1">
          ...
          <li>En cada opción, selecciona el archivo (PDF, Word, Excel o imagen) y presiona <b>Subir</b></li>
          <li>Se guardará como <code>public/pdfs/lista-precios-&lt;slug&gt;.&lt;ext&gt;</code></li>
