...
window.initHomeSlider = () => {
  ...
  new Swiper('.swiper.hero3d-swiper', {
    ...
    breakpoints: {
      0:   { spaceBetween: 12, coverflowEffect: { rotate: 14, depth: 360, modifier: 1.55 } },
      768: { spaceBetween: 18, coverflowEffect: { rotate: 18, depth: 460, modifier: 1.7 } },
      1100:{ spaceBetween: 26, coverflowEffect: { rotate: 20, depth: 520, modifier: 1.8 } },
    },
  });
};